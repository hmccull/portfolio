        ...
        <div id='experience'>
            ...
            <div id='experience-content'>
                <p id='experience-text'>
                    ...
                    ● Implemented client direct requests, quick turnaround feature enhancements in Python RESTful APIs <br />
                    ● Used strong troubleshooting and bug resolution abilities to quickly rectify production API issues using DataDog, EKS, & Postman <br />
                    ...
                    ● Improved cross-team processes by providing feedback and alternative solutions to leadership, which
                    positively impacted client experience
                </p>
            </div>
            <div id='experience-content'>
                <p id='experience-text'>
                    ...
                    <i>Phoenix, AZ | 01/2018 - 07/2022</i> <br />
                    ● Modeled custom database schema and REST API with Active Record, Postgres, and Rails <br />
